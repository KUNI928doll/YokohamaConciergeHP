...
<head>
    <meta charset="utf-8">
    <title>予約代行サービス | YOKOHAMA Concierge | 外国人向け体験サービス・横浜観光・通訳サポート</title>
    <meta name="description" content="YOKOHAMA Conciergeの予約代行サービス。施設・アクティビティ・飲食店などの予約を、プロが代行して手配いたします。多言語対応で安心のサポート。">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- OGP -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="予約代行サービス | YOKOHAMA Concierge">
    <meta property="og:description"
        content="YOKOHAMA Conciergeの予約代行サービス。施設・アクティビティ・飲食店などの予約を、プロが代行して手配いたします。多言語対応で安心のサポート。">
    <meta property="og:url" content="https://yokohama-concierge.jp/service-reserve.html">
    ...
    <meta name="twitter:title" content="予約代行サービス | YOKOHAMA Concierge">
    ...
    <script type="application/ld+json">
  {
    ...
    "url": "https://yokohama-concierge.jp/service-reserve.html",
...
<body>
        ...
        <section class="guide-overview service-reserve">
            <div class="guide-overview__inner">
                ...
                <div class="guide-overview__title-block">
                    <img src="./images/service/icon-reserve.png" alt="" class="guide-overview__title-icon"
                        aria-hidden="true">
                ...
                <div class="map-img">
                    <img src="/images/service-reserve/yoyakudaiko-map@2x.jpg" alt="" width="567" height="298"
                ...
                <div class="category category--stay">
                    ...
                    <div class="category__images">
                        <figure class="category__image">
                            <img src="./images/service-reserve/reservation-circle01@2x.png" alt="ホテルの写真">
                        </figure>
                        <figure class="category__image2">
                            <img src="./images/service-reserve/reservation-circle02@2x.png" alt="ホテルの写真">
                        </figure>
                    </div>
                </div>
                    ...
                    <div class="category__shape">
                        ...
                        <ul class="circle-eat">
                            <li class="circle-eat-img01">
                                <img class="circle-eat-img" src="/images/service-reserve/eat-01nikuryori.png" alt="" width="126"
                                    height="156" loading="lazy" decoding="async">
                                <p class="eat-name">肉料理</p>
                            </li>
                            <li class="circle-eat-img02">
                                <img class="circle-eat-img" src="/images/service-reserve/eat-02bejitarian.png" alt=""
                                    width="118" height="148" loading="lazy" decoding="async">
                                <p class="eat-name">ベジタリアン</p>
                            </li>
                            <li class="circle-eat-img03">
                                <img class="circle-eat-img" src="/images/service-reserve/eat-03tyuka.png" alt="" width="176"
                                    height="207" loading="lazy" decoding="async">
                                <p class="eat-name">中華</p>
                            </li>
                            <li class="circle-eat-img04">
                                <img class="circle-eat-img" src="/images/service-reserve/eat-04washoku.png" alt="" width="182"
                                    height="216" loading="lazy" decoding="async">
                                <p class="eat-name">和食</p>
                            </li>
                            <li class="circle-eat-img05">
                                <img class="circle-eat-img eat-img05" src="/images/service-reserve/eat-05itarian.png" alt=""
                                    width="118" height="152" loading="lazy" decoding="async">
                                <p class="eat-name">イタリア料理</p>
                            </li>
                            <li class="circle-eat-img06">
                                <img class="circle-eat-img eat-img06" src="/images/service-reserve/eat-06runch.png" alt=""
                                    width="118" height="152" loading="lazy" decoding="async">
                                <p class="eat-name">ランチ</p>
                            </li>
                            <li class="circle-eat-img07">
                                <img class="circle-eat-img eat-img07" src="/images/service-reserve/eat-07flench.png" alt=""
                                    width="126" height="156" loading="lazy" decoding="async">
                                <p class="eat-name">フランス料理</p>
                            </li>
                            <li class="circle-eat-img08">
                                <img class="circle-eat-img eat-img08" src="/images/service-reserve/eat-08cafe.png" alt=""
                                    width="115" height="148" loading="lazy" decoding="async">
                                <p class="eat-name">カフェ</p>
                            </li>
                            <li class="circle-eat-img09">
                                <img class="circle-eat-img eat-img09" src="/images/service-reserve/eat-09dinner.png" alt=""
                                    width="164" height="198" loading="lazy" decoding="async">
                                <p class="eat-name">ディナー</p>
                            </li>
                            <li class="circle-eat-img10">
                                <img class="circle-eat-img eat-img10" src="/images/service-reserve/eat-10indo.png" alt=""
                            ...
                            <div class="slider js-slider">
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/paly-slider01@2x.png" alt="" width=""
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/play-slider02@2x.png" alt="" width=""
                                                height="" loading="lazy" decoding="async">
                                        </div>
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/play-slider03@2x.png" alt="" width=""
                                                height="" loading="lazy" decoding="async">
                                        </div>
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/play-slider04@2x.png" alt="" width=""
                                                height="" loading="lazy" decoding="async">
                                        </div>
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/play-slider05@2x.png" alt="" width=""
                                                height="" loading="lazy" decoding="async">
                                        </div>
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/play-slider06@2x.png" alt="" width=""
                                                height="" loading="lazy" decoding="async">
                                        </div>
                                ...
                                <div class="slick-img">
                                    <div class="play-slider__item">
                                        <div class="play-img">
                                            <img src="/images/service-reserve/play-slider07@2x.png" alt="" width=""
                                                height="" loading="lazy" decoding="async">
                                        </div>
    ...
    <script src="../js/service-reserve.js"></script>
