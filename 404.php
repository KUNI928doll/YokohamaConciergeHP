...
<head>
    <meta charset="utf-8">
    <title>ページが見つかりません | YOKOHAMA Concierge | 外国人向け体験サービス・横浜観光・通訳サポート</title>
    <meta name="description" content="お探しのページが見つかりませんでした。YOKOHAMA Conciergeのホームページへお戻りください。">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="robots" content="noindex, nofollow">

    <!-- OGP -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="ページが見つかりません | YOKOHAMA Concierge">
    <meta property="og:description" content="お探しのページが見つかりませんでした。YOKOHAMA Conciergeのホームページへお戻りください。">
    <meta property="og:url" content="https://yokohama-concierge.jp/404.html">
    ...
    <meta name="twitter:title" content="ページが見つかりません | YOKOHAMA Concierge">
    <meta name="twitter:description" content="お探しのページが見つかりませんでした。YOKOHAMA Conciergeのホームページへお戻りください。">
    ...
    <main>
        <div class="error-page__hero">
            ...
            <div class="error-page__actions">
                <a href="index.html" class="error-page__home-btn">ホームに戻る</a>
                    ...
                    <section class="search-area search-area--page">
                        <div class="search-area__inner inner">
                            <form action="search.html" method="get" class="search-area__form">
                                <input type="text" name="q" class="search-area__input" placeholder="例）トランク お預かり サポート">
        ...
        <section class="error-page__links">
            <div class="error-page__links-inner">
                ...
                <div class="error-page__links-grid">
                    <a href="index.html#service-reserve" class="error-page__link-card">
                    ...
                    <a href="service-storage.html" class="error-page__link-card">
                    ...
                    <a href="service-tour-guide.html" class="error-page__link-card">
                    ...
                    <a href="contact.html" class="error-page__link-card">
