    ...
    <div class="privacy-page__inner">
        ...
        <section class="privacy-page__section">
            ...
            <ul class="privacy-page__list">
                ...
                <li>3.トランクお預かりサービス（1m × 1m以内のサイズに限る）
                    <ul class="privacy-page__list--nested">
        ...
        <section class="privacy-page__section">
            ...
            <h3 class="privacy-page__subheading">5. 決済について</h3>
            <p class="privacy-page__text">当社が提供するオンライン決済は、予約代行サービスに対する手数料の支払いを目的とするものであり、宿泊費、飲食代、体験料金その他事業者が提供するサービス料金は含まれません。実際のサービス提供および料金の支払いについては、各事業者の条件・規約に従うものとします。</p>
        </section>
        ...
        <section class="privacy-page__section">
            <h2 class="privacy-page__heading">第10条（予約代行の成立およびキャンセルについて）</h2>
            <ul class="privacy-page__list">
                <li>当社が提供するホテル・飲食店等の予約代行サービスは、当社が提示する候補内容に対し、利用者がいずれか1案を選択し、当社指定のオンライン決済（Stripe）にて予約代行料金の支払いが完了した時点で、正式な依頼として成立するものとします。</li>
                <li>利用者が決済を完了しない場合、当該提案は申し込み未成立とみなし、当社は当該提案を<strong>自動的に無効（キャンセル）</strong>とすることができるものとします。</li>
                <li>なお、決済完了前の段階においては、予約枠の確保、事業者への正式な手配、その他これに付随する業務は一切行われません。</li>
            </ul>
        </section>
