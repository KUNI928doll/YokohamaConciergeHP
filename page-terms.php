...
<head>
  ...
  <title>利用規約 | YOKOHAMA Concierge</title>
...
<body>
            ...
            <nav id="global-nav" class="header__nav header__nav--sp u-visible-sp">
                <div class="spmenu">
                    ...
                    <ul class="spmenu__list">
                        ...
                        <li><a href="#faq"><img src="./images/icon-faq.png" alt="" class="spmenu__icon">よくある質問</a></li>
                        <li><a href="#news"><img src="./images/icon-news.png" alt="" class="spmenu__icon">お知らせ・イベント</a>
                        </li>
  ...
  <main class="privacy-page">
    <div class="privacy-page__inner">
      ...
      <section class="privacy-page__section">
        ...
        <p class="privacy-page__text">個人情報の取り扱いは、当社が別途定める「<a href="privacy.html">プライバシーポリシー（個人情報保護方針）</a>」に従うものとします。</p>
      </section>
  ...
  <footer class="footer">
        ...
        <p class="footer__copy">© 2025 YOKOHAMA Concierge. All Rights Reserved.</p>
    </footer>
