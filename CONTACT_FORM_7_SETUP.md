...
4. 「Contact Form 7」を見つけて「今すぐインストール」をクリック
5. インストール完了後、「有効化」をクリック

## ステップ2: フォームの作成

1. 左メニューに「お問い合わせ」という項目が追加されるので、クリック
2. 「新規追加」をクリック
...
フォームを保存すると、上部に以下のようなショートコードが表示されます：

```
[contact-form-7 id="123" title="お問い合わせフォーム"]
```

このショートコードをコピーしてください（数字は異なる場合があります）。

## ステップ4: 完了！

これで設定完了です。次に `page-contact.php` を更新します。
