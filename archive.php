...
<head>
    <meta charset="utf-8">
    <title>お知らせ・イベント | YOKOHAMA Concierge</title>
    <meta name="description" content="YOKOHAMA Conciergeのお知らせ・イベント情報をご覧いただけます。">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- OGP -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="お知らせ・イベント | YOKOHAMA Concierge">
    <meta property="og:description" content="YOKOHAMA Conciergeのお知らせ・イベント情報をご覧いただけます。">
    <meta property="og:url" content="https://yokohama-concierge.jp/news.html">
    ...
    <main>
        ...
        <section class="news-list">
            <div class="news-list__inner inner">
                ...
                <!-- 記事一覧（投稿がある場合はこちらを使用） -->
                <div class="news-list__grid" style="display: none;">
                    <!-- イベント -->
                    <article class="news-list__card" data-category="event">
                        <a href="#" class="news-list__card-link">
                            <div class="news-list__card-img">
                                <img src="https://placehold.jp/400x250.png?text=Event" alt="秋のヨコハマフェス">
                                <span class="news-list__card-label news-list__card-label--event">イベント</span>
                            </div>
                            <div class="news-list__card-body">
                                <p class="news-list__card-date">2025.10.27</p>
                                <h3 class="news-list__card-title">秋のヨコハマフェス開催！</h3>
                                <p class="news-list__card-text">横浜の秋を満喫できる特別イベントを開催します。グルメや音楽、アートなど盛りだくさんの内容でお届けします。</p>
                            </div>
                        </a>
                    </article>

                    <!-- お知らせ -->
                    <article class="news-list__card" data-category="notice">
                        <a href="#" class="news-list__card-link">
                            <div class="news-list__card-img">
                                <img src="https://placehold.jp/400x250.png?text=Notice" alt="通訳ガイド募集">
                                <span class="news-list__card-label news-list__card-label--notice">お知らせ</span>
                            </div>
                            <div class="news-list__card-body">
                                <p class="news-list__card-date">2025.10.15</p>
                                <h3 class="news-list__card-title">通訳ガイド募集のお知らせ</h3>
                                <p class="news-list__card-text">外国人観光客向けの通訳ガイドを募集しています。英語、中国語、韓国語などの語学力を活かせます。</p>
                            </div>
                        </a>
                    </article>
                    ...
                    <article class="news-list__card" data-category="event">
                        <a href="#" class="news-list__card-link">
                            <div class="news-list__card-img">
                                <img src="https://placehold.jp/400x250.png?text=Event" alt="秋の特別観光プラン">
                                <span class="news-list__card-label news-list__card-label--event">イベント</span>
                            </div>
                            <div class="news-list__card-body">
                                <p class="news-list__card-date">2025.09.30</p>
                                <h3 class="news-list__card-title">秋の特別観光プラン登場！</h3>
                                <p class="news-list__card-text">紅葉シーズンに合わせた特別観光プランをご用意しました。横浜の美しい秋をお楽しみください。</p>
                            </div>
                        </a>
                    </article>
                    ...
                    <article class="news-list__card" data-category="notice">
                        <a href="#" class="news-list__card-link">
                            <div class="news-list__card-img">
                                <img src="https://placehold.jp/400x250.png?text=Notice" alt="臨時休業">
                                <span class="news-list__card-label news-list__card-label--notice">お知らせ</span>
                            </div>
                            <div class="news-list__card-body">
                                <p class="news-list__card-date">2025.09.20</p>
                                <h3 class="news-list__card-title">臨時休業のお知らせ</h3>
                                <p class="news-list__card-text">9月25日（水）は社内研修のため臨時休業とさせていただきます。ご不便をおかけしますがよろしくお願いいたします。</p>
                            </div>
                        </a>
                    </article>
                    ...
                    <article class="news-list__card" data-category="event">
                        <a href="#" class="news-list__card-link">
                            <div class="news-list__card-img">
                                <img src="https://placehold.jp/400x250.png?text=Event" alt="横浜グルメツアー">
                                <span class="news-list__card-label news-list__card-label--event">イベント</span>
                            </div>
                            <div class="news-list__card-body">
                                <p class="news-list__card-date">2025.09.10</p>
                                <h3 class="news-list__card-title">横浜グルメツアー開催</h3>
                                <p class="news-list__card-text">中華街や元町を巡る特別グルメツアーを開催します。地元ガイドが厳選したお店をご案内します。</p>
                            </div>
                        </a>
                    </article>
                    ...
                    <article class="news-list__card" data-category="notice">
                        <a href="#" class="news-list__card-link">
                            <div class="news-list__card-img">
                                <img src="https://placehold.jp/400x250.png?text=Notice" alt="新サービス開始">
                                <span class="news-list__card-label news-list__card-label--notice">お知らせ</span>
                            </div>
                            <div class="news-list__card-body">
                                <p class="news-list__card-date">2025.08.28</p>
                                <h3 class="news-list__card-title">新サービス「トランクお預かり」開始</h3>
                                <p class="news-list__card-text">手ぶらで横浜観光を楽しめる新サービスを開始しました。駅近くで便利にご利用いただけます。</p>
                            </div>
                        </a>
                    </article>
                </div>
