    ...
    <div id="shopSelectModal" class="shop-select-modal" style="display: none;">
        ...
        <div class="shop-select-modal__content">
            ...
            <div class="shop-select-modal__search">
                <label for="shopSearch" class="sr-only">お店を検索</label>
                <input type="search" id="shopSearch" class="shop-select-modal__search-input" placeholder="お店を検索..." aria-label="お店を検索">
            </div>
