...
<head>
    <meta charset="utf-8">
    <title>記事タイトル | お知らせ・イベント | YOKOHAMA Concierge</title>
    <meta name="description" content="YOKOHAMA Conciergeのお知らせ・イベント情報の詳細ページです。">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- OGP -->
    <meta property="og:type" content="article">
    <meta property="og:title" content="記事タイトル | お知らせ・イベント | YOKOHAMA Concierge">
    <meta property="og:description" content="記事の説明文がここに入ります。">
    <meta property="og:url" content="https://yokohama-concierge.jp/news-detail.html">
    ...
    <main>
        ...
        <nav class="breadcrumb" aria-label="Breadcrumb">
            <ul class="breadcrumb__list">
                ...
                <li class="breadcrumb__item">
                    <a href="news.html">お知らせ・イベント</a>
                </li>
                <li class="breadcrumb__item">記事タイトル</li>
            </ul>
        </nav>
            ...
            <div class="news-detail__inner inner">
                ...
                <header class="news-detail__header">
                    <div class="news-detail__meta">
                        <span class="news-detail__label news-detail__label--event">イベント</span>
                        <time class="news-detail__date" datetime="2025-10-27">2025.10.27</time>
                    </div>
                    <h1 class="news-detail__title">秋のヨコハマフェス開催！</h1>
                </header>

                <!-- アイキャッチ画像 -->
                <figure class="news-detail__eyecatch">
                    <img src="https://placehold.jp/1200x600.png?text=Event+Image" alt="秋のヨコハマフェス">
                </figure>

                <!-- 記事本文 -->
                <div class="news-detail__content">
                    <p>横浜の秋を満喫できる特別イベント「秋のヨコハマフェス」を開催いたします。</p>
                    
                    <h2>イベント概要</h2>
                    <p>今年で5回目を迎える「秋のヨコハマフェス」は、横浜の魅力を存分に楽しめる秋の一大イベントです。グルメ、音楽、アート、体験型アクティビティなど、盛りだくさんの内容でお届けします。</p>

                    <h3>開催日時</h3>
                    <ul>
                        <li>日程：2025年11月15日（土）〜 11月17日（月）</li>
                        <li>時間：10:00〜18:00（最終日は17:00まで）</li>
                        <li>会場：山下公園・赤レンガ倉庫周辺</li>
                    </ul>

                    <h3>主なイベント内容</h3>
                    <h4>1. グルメエリア</h4>
                    <p>横浜中華街の名店をはじめ、地元の人気レストランが出店。秋の味覚を使った特別メニューをお楽しみいただけます。</p>

                    <h4>2. 音楽ステージ</h4>
                    <p>地元アーティストによるライブパフォーマンスを毎日開催。ジャズ、ポップス、クラシックなど多彩なジャンルの音楽をお届けします。</p>

                    <h4>3. アート展示</h4>
                    <p>横浜ゆかりのアーティストによる作品展示や、ワークショップを開催。お子様から大人まで楽しめる内容です。</p>

                    <h4>4. 体験型アクティビティ</h4>
                    <p>陶芸体験、着物レンタル、人力車ツアーなど、横浜ならではの体験をご用意しています。</p>

                    <h3>入場料</h3>
                    <p>入場無料（一部有料プログラムあり）</p>

                    <h3>アクセス</h3>
                    <p>みなとみらい線「日本大通り駅」より徒歩5分<br>
                    JR「関内駅」より徒歩15分</p>

                    <h3>お問い合わせ</h3>
                    <p>秋のヨコハマフェス実行委員会<br>
                    TEL: 045-681-2737<br>
                    Email: info@hamanavi-s.jp</p>
                ...
                <div class="news-detail__share">
                    ...
                    <div class="news-detail__share-buttons">
                        <a href="https://twitter.com/intent/tweet?url=https://yokohama-concierge.jp/news-detail.html&text=秋のヨコハマフェス開催！" 
                           target="_blank" rel="noopener noreferrer" class="news-detail__share-btn news-detail__share-btn--twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://yokohama-concierge.jp/news-detail.html" 
                           target="_blank" rel="noopener noreferrer" class="news-detail__share-btn news-detail__share-btn--facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://social-plugins.line.me/lineit/share?url=https://yokohama-concierge.jp/news-detail.html" 
                ...
                <div class="news-detail__back">
                    <a href="news.html" class="btn btn--outline btn--md">
