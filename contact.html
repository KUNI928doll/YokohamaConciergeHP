...
<head>
    <meta charset="utf-8">
    <title>お問い合わせ | YOKOHAMA Concierge | 外国人向け体験サービス・横浜観光・通訳サポート</title>
    <meta name="description" content="YOKOHAMA Conciergeへの各種お問い合わせはこちらから。サービス内容のご質問や予約、ご相談など、お気軽にご連絡ください。">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- OGP -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="お問い合わせ | YOKOHAMA Concierge">
    <meta property="og:description" content="YOKOHAMA Conciergeへの各種お問い合わせはこちらから。サービス内容のご質問や予約、ご相談など、お気軽にご連絡ください。">
    <meta property="og:url" content="https://yokohama-concierge.jp/contact.html">
    ...
    <meta name="twitter:title" content="お問い合わせ | YOKOHAMA Concierge">
    <meta name="twitter:description" content="YOKOHAMA Conciergeへの各種お問い合わせはこちらから。サービス内容のご質問や予約、ご相談など、お気軽にご連絡ください。">
    ...
    <main>
        ...
        <div class="sub-hero">
            ...
            <div class="sub-hero__img">
                <img src="./images/contact/contact-hero.png" alt="ベイブリッチ">
            </div>
                ...
                <form class="inquiry-form" action="#" method="post">
                    <div class="inquiry-form__section">
                        ...
                        <div class="inquiry-form__grid">
                            <div class="inquiry-form__field">
                                ...
                                <input type="text" id="contact-name" name="name" class="inquiry-form__input" placeholder="例）横浜 太郎" required>
                            </div>
                            <div class="inquiry-form__field">
                                <label for="contact-kana" class="inquiry-form__label">ふりがな<span class="inquiry-form__required">必須</span></label>
                                <input type="text" id="contact-kana" name="kana" class="inquiry-form__input" placeholder="例）よこはま たろう" required>
                            </div>
                            <div class="inquiry-form__field">
                                <label for="contact-email" class="inquiry-form__label">メールアドレス<span class="inquiry-form__required">必須</span></label>
                                <input type="email" id="contact-email" name="email" class="inquiry-form__input" placeholder="info@example.com" required>
                            </div>
                            <div class="inquiry-form__field">
                                <label for="contact-tel" class="inquiry-form__label">電話番号<span class="inquiry-form__required">必須</span></label>
                                <input type="tel" id="contact-tel" name="tel" class="inquiry-form__input" placeholder="090-1234-5678">
                    ...
                    <div class="inquiry-form__section">
                        ...
                        <div class="inquiry-form__field inquiry-form__field--full">
                            ...
                            <div class="inquiry-form__checkboxes">
                                <label class="inquiry-form__checkbox">
                                    <input type="checkbox" name="type[]" value="reservation">
                                    <span>予約について</span>
                                </label>
                                <label class="inquiry-form__checkbox">
                                ...
                                <label class="inquiry-form__checkbox">
                                    <input type="checkbox" name="type[]" value="estimate">
                                    <span>見積もり依頼</span>
                                </label>
                                <label class="inquiry-form__checkbox">
                        ...
                        <div class="inquiry-form__field inquiry-form__field--full">
                            ...
                            <textarea id="contact-message" name="message" class="inquiry-form__textarea" rows="6" placeholder="ご希望サービスや具体的な内容をご入力ください" required></textarea>
                        </div>
                    </div>

                    <div class="inquiry-form__section inquiry-form__section--privacy">
                        <p class="inquiry-form__privacy-text">個人情報のお取り扱いについては「<a href="privacy.html" class="inquiry-form__privacy-link" target="_blank">プライバシーポリシー</a>」をご確認ください。</p>
                        
                        <label class="inquiry-form__privacy-checkbox">
                            <input type="checkbox" name="privacy" id="privacy-agree" required>
                            <span>プライバシーポリシーに同意する<span class="inquiry-form__required">必須</span></span>
                        </label>
                    </div>

                    <div class="inquiry-form__actions">
                        <button type="button" class="btn btn--blue btn--lg" id="confirm-button">入力内容の確認 →</button>
                    </div>
                </form>
            </div>
        </section>
        ...
        <!-- 確認画面モーダル -->
        <div class="inquiry-confirm-modal" id="confirm-modal">
            <div class="inquiry-confirm-modal__overlay"></div>
            <div class="inquiry-confirm-modal__content">
                <div class="inquiry-confirm-modal__header">
                    <h3 class="inquiry-confirm-modal__title">入力内容の確認</h3>
                    <button type="button" class="inquiry-confirm-modal__close" id="modal-close">×</button>
                </div>
                <div class="inquiry-confirm-modal__body" id="confirm-content">
                    <!-- 確認内容がJavaScriptで挿入されます -->
                </div>
                <div class="inquiry-confirm-modal__actions">
                    <button type="button" class="btn btn--white btn--md" id="back-button">← 戻って修正する</button>
                    <button type="button" class="btn btn--blue btn--lg" id="submit-button">送信する</button>
                </div>
            </div>
        </div>

        <!-- 送信完了モーダル -->
        <div class="inquiry-thanks-modal" id="thanks-modal">
            <div class="inquiry-thanks-modal__overlay"></div>
            <div class="inquiry-thanks-modal__content">
                <div class="inquiry-thanks-modal__icon">
                    <svg viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="26" cy="26" r="25" fill="#4CAF50"/>
                        <path fill="none" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" d="M14 27l8 8 16-16"/>
                    </svg>
                </div>
                <h3 class="inquiry-thanks-modal__title">送信完了</h3>
                <p class="inquiry-thanks-modal__message">
                    お問い合わせを受け付けました。<br>
                    ご入力いただいたメールアドレス宛に<br class="u-visible-sp">受付確認メールをお送りしました。
                </p>
                <div class="inquiry-thanks-modal__info">
                    <p class="inquiry-thanks-modal__info-text">
                        担当者が内容を確認し、<br class="u-visible-sp">2営業日以内にご連絡いたします。<br>
                        今しばらくお待ちください。
                    </p>
                    <p class="inquiry-thanks-modal__note">
                        ※メールが届かない場合は、迷惑メールフォルダをご確認いただくか、<br class="u-visible-sp">お電話にてお問い合わせください。
                    </p>
                </div>
                <div class="inquiry-thanks-modal__actions">
                    <a href="index.html" class="btn btn--blue btn--lg">トップページへ戻る</a>
                </div>
            </div>
        </div>
            </div>
